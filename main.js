...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ----------------------------------------------------------
     ...
     - Handled by motion.js (GSAP + ScrollTrigger).
     - This section intentionally left empty; the IntersectionObserver
       implementation was removed to avoid fighting GSAP tweens.
     ---------------------------------------------------------- */
  ...
  /* ----------------------------------------------------------
     ...
     - #menuClose -> closes #mobileOverlay
     - .mobile-link -> closes #mobileOverlay on click
     ---------------------------------------------------------- */

  const menuBtn = document.querySelector("#menuBtn");
  // HTML uses id="menuClose" on the close button across all pages
  const mobileClose = document.querySelector("#menuClose");
  const mobileOverlay = document.querySelector("#mobileOverlay");
